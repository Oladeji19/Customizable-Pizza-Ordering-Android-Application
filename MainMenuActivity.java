...
public class MainMenuActivity {
    ...
    protected void onBuildYourOwnClick(ActionEvent event) throws IOException {
        ...
        stage.show();
        BuildYourOwnActivity byoController = loadMe.getController();
    ...
    protected void onCurrentOrderClick(ActionEvent event) throws IOException {
        ...
        CurrentOrderActivity currentOrderController = loader.getController();
    ...
    protected void onStoreOrdersClick(ActionEvent event) throws IOException {
        ...
        StoreOrdersActivity storeOrdersController = loader.getController();
     ...
     */
    public MainMenuActivity getReference(){
        return this;
    }
