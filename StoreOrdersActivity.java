...
public class StoreOrdersActivity implements Initializable {
    ...
    private MainMenuActivity mainController = new MainMenuActivity().getReference();
     ...
     */
    public void setMainController(MainMenuActivity controller) {
    ...
    void displayPizzas(ActionEvent event) {
        ...
        orders = new MainMenuActivity().getReference().getStoreOrders();
